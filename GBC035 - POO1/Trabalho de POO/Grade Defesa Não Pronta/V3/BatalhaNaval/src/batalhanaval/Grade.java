...
public class Grade {
    ...
    public Grade(String tipo){
        ...
        cinco1.setBackground(new Color(254,233,119));
        amostra.add(cinco1);
        ...
        quatro1.setBackground(new Color(254,233,119));
        amostra.add(quatro1);
        ...
        tres1.setBackground(new Color(254,233,119));
        amostra.add(tres1);
        ...
        dois1.setBackground(new Color(254,233,119));
        amostra.add(dois1);
        ...
        um1.setBackground(new Color(254,233,119));
        amostra.add(um1);
