...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void BotaoEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoEntrarActionPerformed
        // Aqui deverá ser feita a consulta no banco de dados para indicar qual janela será aberta
        //Usarei temporariamente uma string pra testes
        String cargo;  
        cargo = "Recepcionista";     //Cargo na verdade deverá receber o cargo do funcionário cujo cpf foi especificado, através de uma consulta no database
        if(cargo == "Gerente"){
            this.dispose();
            TelaGerente telagerente = new TelaGerente();
            
        }else if (cargo == "Gerente Restaurante"){
            this.dispose();
            ...
            JOptionPane.showMessageDialog(null, "Esse funcionário não possui login");
        }
